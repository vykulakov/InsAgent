...
$(function () {
    ...
    $('#actToolbar button').on('click', function () {
        ...
        var numberFrom = 0;
        var numberTo = 0;
        var bsos = $table.bootstrapTable('getAllSelections').sort(function (a, b) {
    ...
    $('#actionToolbar button').on('click', function () {
        var bsos = $table.bootstrapTable('getAllSelections');
        if (bsos.length === 0) {
    ...
    if (!!cookie && !!cookie.filter) {
        ...
        $table.bootstrapTable('refresh', {url: '/bso/bso'});
    } else {
        $table.bootstrapTable('refresh', {url: '/bso/bso'});
    }
