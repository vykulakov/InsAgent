...
<c:param name="content">
	...
	<div id="editUnitModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
				...
				<form id="editUnitForm" method="post" action="<c:url value='/updateUnitJson.action'/>">
					...
					<div id="editUnitBody" class="modal-body">
						<div class="form-group">
							...
							<input id="unitNameInput" name="unit.name" type="text" class="form-control" placeholder="Название" required>
						</div>
						<div class="form-group">
							<label for="unitTypeInput" class="control-label">Тип:</label>
							<select id="unitTypeInput" name="unit.type.id" class="form-control" data-selected="bar" data-selected-error="Необходимо выбрать тип" required>
						...
						<div class="form-group">
							...
							<select id="unitCityInput" name="unit.city.id" class="form-control" data-selected="bar" data-selected-error="Необходимо выбрать город" required>
	...
	<div id="removeUnitModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
    	...
    	<div class="panel-body">
			<form id="filterUnitForm" class="form-horizontal">
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input id="filterUnitNameInput" name="filter.name" type="text" class="form-control" placeholder="Название"/>
					</div>
				</div>
				<div class="form-group">
					<label for="filterUnitTypesInput" class="col-sm-2 control-label">Типы:</label>
					<div class="col-sm-10">
						<select id="filterUnitTypesInput" name="filter.types" class="form-control" multiple>
							<c:forEach var="type" items="${ types }">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select id="filterUnitCitiesInput" name="filter.cities" class="form-control" multiple>
							<c:forEach var="city" items="${ cities }">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<select id="filterUnitRemovedInput" name="filter.removed" class="form-control">
				...
				<div class="form-group">
					<div class="col-sm-2">
						<button id="filterUnitSubmitButton" type="submit" class="btn btn-primary pull-right">Применить</button>
					</div>
					<div class="col-sm-10">
