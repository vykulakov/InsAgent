...
<c:param name="content">
	...
	<div id="editCityModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
				...
				<form id="editCityForm" method="post" action="<c:url value='/updateCityJson.action'/>">
					...
					<div id="editCityBody" class="modal-body">
						<div class="form-group">
							...
							<input id="cityNameInput" name="city.name" type="text" class="form-control" placeholder="Название" required>
						</div>
						<div class="form-group">
	...
	<div id="removeCityModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
    	...
    	<div class="panel-body">
			<form id="filterCityForm" class="form-horizontal">
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input id="filterCityNameInput" name="filter.name" type="text" class="form-control" placeholder="Название"/>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<div class="col-sm-2">
						<button id="filterCitySubmitButton" type="submit" class="btn btn-primary pull-right">Применить</button>
					</div>
					<div class="col-sm-10">
